...
export default function SectionHeading({ eyebrow, title, text, subtitle, link, href = '/shop' }) {
    return (
        <div className="container-width mb-8 flex items-end justify-between gap-4">
            <div>
            ...
            {link && (
                <Link href={href} className="shrink-0 text-sm font-bold text-[#c92532] hover:underline">
                    {link}
                </Link>
            )}
        </div>
