...
export default function NewArrivals() {
  ...
  return <section className="section-pad bg-[#fffaf7]">
  <SectionHeading eyebrow="Fresh Picks" title="New Arrivals" text="Discover the latest products added to Gift Zone." link="View All →" href="/shop?sort=newest" />
