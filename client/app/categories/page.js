                    ...
                    <div className="container-width">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-500 md:text-base">
                                From birthdays and anniversaries to weddings and festivals,
                                discover thoughtful gifts made for every special occasion.
                            </p>
                        </div>
                        ...
                        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                            {categories.map((item, index) => (
                                <Link
                                    ...
                                    className={`group relative overflow-hidden rounded-3xl bg-[#fff7f3] ${
                                        index === 0 || index === 3
                                            ? 'lg:row-span-2'
                                            : ''
                                    }`}
                    ...
                    <div className="container-width">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <p className="mt-4 text-sm leading-7 text-slate-500">
                                Explore our complete collection and find something special
