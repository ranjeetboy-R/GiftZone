...
<form onSubmit={submit} className="rounded-xl border p-6 md:p-8">
  ...
  <button className="rounded-md bg-[#c92532] py-3 font-bold text-white">Send Message</button>{sent && <p className="text-sm font-semibold text-green-600">Thanks! Your demo message has been received.</p>}</div>
</form>
</div>
</main>
<Footer />
